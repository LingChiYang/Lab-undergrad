...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.myproject_axi.autotvin_in_data.dat"
         "c.myproject_axi.autotvin_in_last_V.dat"
         "c.myproject_axi.autotvin_out_data.dat"
         "c.myproject_axi.autotvin_out_last_V.dat"
         "c.myproject_axi.autotvout_out_data.dat"
         "c.myproject_axi.autotvout_out_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.myproject_axi.autotvout_out_data.dat"
         "rtl.myproject_axi.autotvout_out_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
