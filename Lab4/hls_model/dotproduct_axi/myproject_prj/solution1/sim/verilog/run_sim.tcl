...
if {[file isfile myproject_axi.autotvin.dat]} {
	file delete -force myproject_axi.autotvin.dat
}

if {[file isfile myproject_axi.autotvout.dat]} {
	file delete -force myproject_axi.autotvout.dat
}
