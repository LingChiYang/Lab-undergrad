...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "myproject_axi.autotvin.dat"
	set constFileTvOut       "myproject_axi.autotvout.dat"
	set constFileHdlTvIn     "myproject_axi.autohdltvin.dat"
	set constFileHdlTvOut    "myproject_axi.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
