...
entity myproject_Loop_1_proc_w2_V_rom is 
    generic(
             DWIDTH     : integer := 15; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of myproject_Loop_1_proc_w2_V_rom is 
...
entity myproject_Loop_1_proc_w2_V is
    generic (
...
architecture arch of myproject_Loop_1_proc_w2_V is
    component myproject_Loop_1_proc_w2_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    myproject_Loop_1_proc_w2_V_rom_U :  component myproject_Loop_1_proc_w2_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
