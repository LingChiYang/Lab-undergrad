...
`define AUTOTB_TVIN_in_data  "./c.myproject_axi.autotvin_in_data.dat"
`define AUTOTB_TVIN_in_last_V  "./c.myproject_axi.autotvin_in_last_V.dat"
`define AUTOTB_TVIN_out_data  "./c.myproject_axi.autotvin_out_data.dat"
`define AUTOTB_TVIN_out_last_V  "./c.myproject_axi.autotvin_out_last_V.dat"
`define AUTOTB_TVIN_in_data_out_wrapc  "./rtl.myproject_axi.autotvin_in_data.dat"
`define AUTOTB_TVIN_in_last_V_out_wrapc  "./rtl.myproject_axi.autotvin_in_last_V.dat"
`define AUTOTB_TVIN_out_data_out_wrapc  "./rtl.myproject_axi.autotvin_out_data.dat"
`define AUTOTB_TVIN_out_last_V_out_wrapc  "./rtl.myproject_axi.autotvin_out_last_V.dat"
`define AUTOTB_TVOUT_out_data  "./c.myproject_axi.autotvout_out_data.dat"
`define AUTOTB_TVOUT_out_last_V  "./c.myproject_axi.autotvout_out_last_V.dat"
`define AUTOTB_TVOUT_out_data_out_wrapc  "./impl_rtl.myproject_axi.autotvout_out_data.dat"
`define AUTOTB_TVOUT_out_last_V_out_wrapc  "./impl_rtl.myproject_axi.autotvout_out_last_V.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.myproject_axi.autotvout_out_data.dat", "r");
    fp2 = $fopen("./impl_rtl.myproject_axi.autotvout_out_data.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.myproject_axi.autotvout_out_data.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.myproject_axi.autotvout_out_data.dat\"!");
    else begin
        $display("Comparing rtl.myproject_axi.autotvout_out_data.dat with impl_rtl.myproject_axi.autotvout_out_data.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.myproject_axi.autotvout_out_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.myproject_axi.autotvout_out_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.myproject_axi.autotvout_out_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.myproject_axi.autotvout_out_last_V.dat\"!");
    else begin
        $display("Comparing rtl.myproject_axi.autotvout_out_last_V.dat with impl_rtl.myproject_axi.autotvout_out_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
begin
    ...
    `define STREAM_SIZE_OUT_out_data "./stream_size_out_out_data.dat"
