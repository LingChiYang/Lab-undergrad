...
void myproject_float(
    ...
    input_axi_t input_3_ap[N_IN];
    nnet::convert_data<float, input_axi_t, N_IN>(input_3, input_3_ap);

    output_axi_t layer12_out_ap[N_OUT];

    myproject_axi(input_3_ap,layer12_out_ap);
...
void myproject_double(
    ...
    input_axi_t input_3_ap[N_IN];
    nnet::convert_data<double, input_axi_t, N_IN>(input_3, input_3_ap);
